            ...
            <div class="card">
                <form action="{{ request()->fullUrl() }}" method="GET" >
                    <div class="card-header">
                        ...
                        <a href="/admin/categories/create" class="btn btn-primary btn-sm float-right">
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td style="white-space: nowrap;" width="10%">
                                    <a href="/admin/categories/{{ $category->id }}/edit" class="btn btn-secondary btn-sm mr-2 float-left">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action=" {{ route('categories.destroy', ['id' => $category->id ]) }}" method="POST" class="ml-4 mr-4" >
                                        {{ method_field('DELETE') }}
                                        @csrf
